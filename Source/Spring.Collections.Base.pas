...
{$ENDIF}
  ...
  protected
    function GetReverseEnumerator: IEnumerator<T>; virtual;
  public
    ...
    function LastOrDefault(const predicate: TPredicate<T>; const defaultValue: T): T; overload; virtual;
...
function TEnumerableBase<T>.GetReverseEnumerator: IEnumerator<T>;
begin
  Result:= nil;
end;
